 ...
 */
class Pessoa extends \models\Pessoa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'models\\Pessoa' . "\0" . 'id', '' . "\0" . 'models\\Pessoa' . "\0" . 'nome', '' . "\0" . 'models\\Pessoa' . "\0" . 'genero', '' . "\0" . 'models\\Pessoa' . "\0" . 'nacionalidade', '' . "\0" . 'models\\Pessoa' . "\0" . 'telefone', '' . "\0" . 'models\\Pessoa' . "\0" . 'imagem', '' . "\0" . 'models\\Pessoa' . "\0" . 'email', '' . "\0" . 'models\\Pessoa' . "\0" . 'bi', '' . "\0" . 'models\\Pessoa' . "\0" . 'documento');
        }
    ...
    public function getBi()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBi', array());
    ...
    public function setBi($bi)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBi', array($bi));

        return parent::setBi($bi);
    }
