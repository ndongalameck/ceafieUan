 ...
 */
class Modulo extends \models\Modulo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'models\\Modulo' . "\0" . 'id', '' . "\0" . 'models\\Modulo' . "\0" . 'nome', '' . "\0" . 'models\\Modulo' . "\0" . 'curso');
        }
