 ...
 */
class Programa extends \models\Programa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'models\\Programa' . "\0" . 'id', '' . "\0" . 'models\\Programa' . "\0" . 'data', '' . "\0" . 'models\\Programa' . "\0" . 'local', '' . "\0" . 'models\\Programa' . "\0" . 'curso', '' . "\0" . 'models\\Programa' . "\0" . 'docente', '' . "\0" . 'models\\Programa' . "\0" . 'modulo');
        }
     ...
     * {@inheritDoc}
     */
    public function setDocente(\models\Docente $docente)
    {
