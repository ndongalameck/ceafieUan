 ...
 */
class Curso extends \models\Curso implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'models\\Curso' . "\0" . 'id', '' . "\0" . 'models\\Curso' . "\0" . 'descricao', '' . "\0" . 'models\\Curso' . "\0" . 'nome');
        }
