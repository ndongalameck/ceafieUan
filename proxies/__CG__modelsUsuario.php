 ...
 */
class Usuario extends \models\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'models\\Usuario' . "\0" . 'id', '' . "\0" . 'models\\Usuario' . "\0" . 'login', '' . "\0" . 'models\\Usuario' . "\0" . 'senha', '' . "\0" . 'models\\Usuario' . "\0" . 'nivel', '' . "\0" . 'models\\Usuario' . "\0" . 'pessoa');
        }
